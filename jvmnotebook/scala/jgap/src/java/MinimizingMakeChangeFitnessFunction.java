...
public class MinimizingMakeChangeFitnessFunction extends FitnessFunction {
     ...
     * 
     */
    private static final long serialVersionUID = 4670413798620487487L;
    ...
    public double evaluate(IChromosome a_subject) {
        // Take care of the fitness evaluator. It could either be weighting
        // higher
        ...
        // Step 2: We divide the fitness value by a penalty based on the number
        // of
